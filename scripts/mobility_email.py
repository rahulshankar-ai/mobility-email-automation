...
def main():
    ...
    if not fresh_stories:
        print("No new stories this week.")
        return
    ...
    print(f"Sent {len(fresh_stories)} stories to {len(RECIPIENTS)} recipients")
